...
pico.version = "0.10.50208"; // Update by package.json.
...
pico.Image = class {
	...
	// Image color. (6 gray scale system colors: 0:ffffff 1:dfdfdf 2:bfbfbf 3:7f7f7f 4:3f3f3f 5:000000)
	...
	static csprites = { // Char sprite table.
		"0": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,4, 5,-1,2,0,2,0],
		"1": [5,0,-2,0,0,4],
		"2": [5,-1,-2,0,2,0, 5,1,-2,0,0,2,  5,-1,0,0,2,0, 5,-1,0,0,0,2, 5,-1,2,0,2,0],
		"3": [5,-1,-2,0,2,0, 5,1,-2,0,0,4,  5,-1,0,0,2,0, 5,-1,2,0,2,0],
		"4": [5,-1,-2,0,0,2, 5,1,-2,0,0,4,  5,-1,0,0,2,0],
		"5": [5,-1,-2,0,2,0, 5,-1,-2,0,0,2, 5,-1,0,0,2,0, 5,1,0,0,0,2,  5,-1,2,0,2,0],
		"6": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,-1,0,0,2,0, 5,1,0,0,0,2,  5,-1,2,0,2,0],
		"7": [5,-1,-2,0,2,0, 5,1,-2,0,0,4],
		"8": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,4, 5,-1,0,0,2,0, 5,-1,2,0,2,0],
		"9": [5,-1,-2,0,2,0, 5,-1,-2,0,0,2, 5,1,-2,0,0,4, 5,-1,0,0,2,0, 5,-1,2,0,2,0],
		"A": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,4, 5,-1,0,0,2,0],
		"B": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,1, 5,-1,0,0,1,0, 5,1,1,0,0,1, 5,-1,2,0,2,0],
		"C": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,-1,2,0,2,0],
		"D": [5,-1,-2,0,1,0, 5,-1,-2,0,0,4, 5,1,-1,0,0,2, 5,-1,2,0,1,0],
		"E": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,-1,0,0,2,0, 5,-1,2,0,2,0],
		"F": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,-1,0,0,2,0],
		"G": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,-1,2,0,2,0, 5,1,0,0,0,1],
		"H": [5,-1,-2,0,0,4, 5,1,-2,0,0,4,  5,-1,0,0,2,0],
		"I": [5,-1,-2,0,2,0, 5,0,-2,0,0,4,  5,-1,2,0,2,0],
		"J": [5,-1,1,0,0,1,  5,1,-2,0,0,4,  5,-1,2,0,2,0],
		"K": [5,-1,-2,0,0,4, 5,-1,0,0,1,0,  5,1,-2,0,0,1, 5,1,1,0,0,1],
		"L": [5,-1,-2,0,0,4, 5,-1,2,0,2,0],
		"M": [5,-1,-2,0,0,4, 5,0,-1,0,0,1,  5,1,-2,0,0,4],
		"N": [5,-1,-2,0,0,4, 5,-1,-2,0,2,0, 5,1,-2,0,0,4],
		"O": [5,-1,-2,0,2,1, 5,-1,-1,0,0,3, 5,1,-1,0,0,3, 5,-1,2,0,2,0],
		"P": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,2, 5,-1,0,0,2,0],
		"Q": [5,-1,-2,0,2,0, 5,-1,-2,0,0,3, 5,1,-2,0,0,2, 5,-1,1,0,1,0, 5,1,2],
		"R": [5,-1,-2,0,2,0, 5,-1,-2,0,0,4, 5,1,-2,0,0,1, 5,-1,0,0,1,0, 5,1,1,0,0,1],
		"S": [5,-1,-2,0,2,0, 5,-1,-2,0,0,1, 5,0,0,        5,1,1,0,0,1,  5,-1,2,0,2,0],
		"T": [5,-1,-2,0,2,0, 5,0,-2,0,0,4],
		"U": [5,-1,-2,0,0,4, 5,1,-2,0,0,4,  5,-1,2,0,2,0],
		"V": [5,-1,-2,0,0,3, 5,1,-2,0,0,3,  5,0,2],
		"W": [5,-1,-2,0,0,4, 5,0,0,0,0,1,   5,1,-2,0,0,4],
		"X": [5,-1,-2,0,0,1, 5,-1,1,0,0,1,  5,0,0,        5,1,-2,0,0,1, 5,1,1,0,0,1],
		"Y": [5,-1,-2,0,0,1, 5,0,0,0,0,2,   5,1,-2,0,0,1],
		"Z": [5,-1,-2,0,2,0, 5,1,-2,0,0,1,  5,0,0,        5,-1,1,0,0,1, 5,-1,2,0,2,0],
		".": [5,0,2],
		"-": [5,-1,0,0,2,0],
		":": [5,0,-1,-1,0,1],
		"/": [5,-1,2,-1,0,0, 5,0,-1,0,0,2,  5,1,-2],
		"'": [5,0,-2,0,0,1],
		",": [5,0,1,0,0,1],
		"!": [5,0,-2,0,0,2,  5,0,2],
		"?": [5,-1,-2,0,2,0, 5,1,-2,0,0,1,  5,0,0,        5,0,2],
		"+": [5,-1,0,0,2,0,  5,0,-1,0,0,2],
		"=": [5,-1,-1,0,2,0, 5,-1,1,0,2,0],
		"*": [5,-1,-1,       5,-1,1,        5,0,0,        5,1,-1,       5,1,1],
		"@": [5,-1,-1,0,2,0, 5,-1,-1,0,0,2, 5,-1,1,0,2,0, 5,1,-1,0,0,2],
		"&": [5,0,-1,        5,-1,0,0,2,1],
		"%": [5,-1,-1,0,2,1, 5,0,1],
		"$": [5,-1,0,        5,0,-1,0,1,2],
		"#": [5,-1,-1,0,1,2, 5,1,0],
