...
async function appLoad() {
	...
	const extraCharSprites = { // Extra char sprite table.
		...
		"ゐ": picoCode6("077911951922942933924944915955"),
		"ゑ": picoCode6("077911951922942933924944915955"),

		"▼": picoCode6("077911921931941951912922932942952923933943924934944935"),
...
async function appMain() {
	...
	picoRect(0, 0,-48,144,64, 0,1);
	picoText(figures[state], -1, 0,-48,136,56, 0,1);
	picoText(texts[state].substr(0,pressing?tlength-1:playing), -1, 0,36,152,96, 0,1);
}
