...
async function appLoad() {
	...
	const extraCharSprites = { // Extra char sprite table.
		...
		"か": picoCode6("077921941912922932952923943914944915945"),
		"が": picoCode6("099951971932952972923933943963934954925955926956"),
...
*/
	...
	let extraChars = Object.keys(extraCharSprites);
	for (let i = 1; i <= 6; i++) {
		const llength = 19 * 1;
		labels[i] = "";
...
async function appMain() {
	...
	picoClear();
	picoText(labels[state], -1, 0,-80,152,8, 0,1)
	picoText(figures[state], -1, 0,-40,152,72, 0,1);
	picoRect(0, 0,48,160,96, 0,1);
