...
const dots = [ // Dotted design pixels.
	[0,6,6, 5,3,3],
	[0,6,6, 4,1,5, 4,5,1],
	[0,6,6, 6,3,3, 6,1,5, 6,5,1],
	[0,6,6, 8,1,1, 8,1,5, 8,5,1, 8,5,5],
	[0,6,6, 7,3,3, 7,1,1, 7,1,5, 7,5,1, 7,5,5],
	[0,6,6, 9,1,1, 9,1,3, 9,1,5, 9,5,1, 9,5,3, 9,5,5],
	[0,6,6, 2,3,3, 2,1,1, 2,1,3, 2,1,5, 2,5,1, 2,5,3, 2,5,5],
	[0,6,6, 1,1,1, 1,1,3, 1,3,1, 1,3,5, 1,1,5, 1,5,1, 1,5,3, 1,5,5],
	[0,6,6, 3,3,3, 3,1,1, 3,1,3, 3,3,1, 3,3,5, 3,1,5, 3,5,1, 3,5,3, 3,5,5],
];
const nums = [ // Numbered design pixels.
	[0,6,6, 5,2,1,0,1,0, 5,2,1,0,0,4, 5,4,1,0,0,4, 5,2,5,0,2,0], // 0
	[0,6,6, 4,3,1,0,0,4], // 1
	[0,6,6, 4,2,1,0,2,0, 4,4,1,0,0,2, 4,2,3,0,2,0, 4,2,3,0,0,2, 4,2,5,0,2,0], // 2
	[0,6,6, 4,2,1,0,2,0, 4,4,1,0,0,4, 4,2,3,0,2,0, 4,2,5,0,2,0], // 3
	[0,6,6, 4,2,1,0,0,2, 4,4,1,0,0,4, 4,2,3,0,2,0], // 4
	[0,6,6, 4,2,1,0,2,0, 4,2,1,0,0,2, 4,2,3,0,2,0, 4,4,3,0,0,2, 4,2,5,0,2,0], // 5
	[0,6,6, 4,2,1,0,2,0, 4,2,1,0,0,4, 4,2,3,0,2,0, 4,4,3,0,0,2, 4,2,5,0,2,0], // 6
	[0,6,6, 4,2,1,0,2,0, 4,4,1,0,0,4], // 7
	[0,6,6, 4,2,1,0,2,0, 4,2,1,0,0,4, 4,4,1,0,0,4, 4,2,3,0,2,0, 4,2,5,0,2,0], // 8
	[0,6,6, 4,2,1,0,2,0, 4,2,1,0,0,2, 4,4,1,0,0,4, 4,2,3,0,2,0, 4,2,5,0,2,0], // 9
	[0,6,6, 4,1,1,0,0,4, 4,3,1,0,1,0, 4,3,1,0,0,4, 4,5,1,0,0,4, 4,3,5,0,2,0], // 10
	[0,6,6, 6,1,1,0,0,4, 6,5,1,0,0,4], // 11
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,5,1,0,0,2, 6,3,3,0,2,0, 6,3,3,0,0,2, 6,3,5,0,2,0], // 12
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,5,1,0,0,4, 6,3,3,0,2,0, 6,3,5,0,2,0], // 13
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,0,2, 6,5,1,0,0,4, 6,3,3,0,2,0], // 14
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,3,1,0,0,2, 6,3,3,0,2,0, 6,5,3,0,0,2, 6,3,5,0,2,0], // 15
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,3,1,0,0,4, 6,3,3,0,2,0, 6,5,3,0,0,2, 6,3,5,0,2,0], // 16
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,5,1,0,0,4], // 17
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,3,1,0,0,4, 6,5,1,0,0,4, 6,3,3,0,2,0, 6,3,5,0,2,0], // 18
	[0,6,6, 6,1,1,0,0,4, 6,3,1,0,2,0, 6,3,1,0,0,2, 6,5,1,0,0,4, 6,3,3,0,2,0, 6,3,5,0,2,0], // 19
	[0,6,6, 6,0,1,0,2,0, 6,2,1,0,0,2, 6,0,3,0,2,0, 6,0,3,0,0,2, 6,0,5,0,2,0, 6,4,1,0,1,0, 6,4,1,0,0,4, 6,6,1,0,0,4, 6,4,5,0,2,0], // 20
];
const kcents = [-1.0,
